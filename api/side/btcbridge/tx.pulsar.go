...
var _ protoreflect.List = (*_MsgUpdateTrustedOracles_2_list)(nil)

type _MsgUpdateTrustedOracles_2_list struct {
	list *[]string
}

func (x *_MsgUpdateTrustedOracles_2_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_MsgUpdateTrustedOracles_2_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfString((*x.list)[i])
}

func (x *_MsgUpdateTrustedOracles_2_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	(*x.list)[i] = concreteValue
}

func (x *_MsgUpdateTrustedOracles_2_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	*x.list = append(*x.list, concreteValue)
}

func (x *_MsgUpdateTrustedOracles_2_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message MsgUpdateTrustedOracles at list field Oracles as it is not of Message kind"))
}

func (x *_MsgUpdateTrustedOracles_2_list) Truncate(n int) {
	*x.list = (*x.list)[:n]
}

func (x *_MsgUpdateTrustedOracles_2_list) NewElement() protoreflect.Value {
	v := ""
	return protoreflect.ValueOfString(v)
}

func (x *_MsgUpdateTrustedOracles_2_list) IsValid() bool {
	return x.list != nil
}

var (
	md_MsgUpdateTrustedOracles         protoreflect.MessageDescriptor
	fd_MsgUpdateTrustedOracles_sender  protoreflect.FieldDescriptor
	fd_MsgUpdateTrustedOracles_oracles protoreflect.FieldDescriptor
)

func init() {
	file_side_btcbridge_tx_proto_init()
	md_MsgUpdateTrustedOracles = File_side_btcbridge_tx_proto.Messages().ByName("MsgUpdateTrustedOracles")
	fd_MsgUpdateTrustedOracles_sender = md_MsgUpdateTrustedOracles.Fields().ByName("sender")
	fd_MsgUpdateTrustedOracles_oracles = md_MsgUpdateTrustedOracles.Fields().ByName("oracles")
}

var _ protoreflect.Message = (*fastReflection_MsgUpdateTrustedOracles)(nil)

type fastReflection_MsgUpdateTrustedOracles MsgUpdateTrustedOracles

func (x *MsgUpdateTrustedOracles) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgUpdateTrustedOracles)(x)
}

func (x *MsgUpdateTrustedOracles) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_MsgUpdateTrustedOracles_messageType fastReflection_MsgUpdateTrustedOracles_messageType
var _ protoreflect.MessageType = fastReflection_MsgUpdateTrustedOracles_messageType{}

type fastReflection_MsgUpdateTrustedOracles_messageType struct{}

func (x fastReflection_MsgUpdateTrustedOracles_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgUpdateTrustedOracles)(nil)
}
func (x fastReflection_MsgUpdateTrustedOracles_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgUpdateTrustedOracles)
}
func (x fastReflection_MsgUpdateTrustedOracles_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgUpdateTrustedOracles
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgUpdateTrustedOracles) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgUpdateTrustedOracles
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgUpdateTrustedOracles) Type() protoreflect.MessageType {
	return _fastReflection_MsgUpdateTrustedOracles_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgUpdateTrustedOracles) New() protoreflect.Message {
	return new(fastReflection_MsgUpdateTrustedOracles)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgUpdateTrustedOracles) Interface() protoreflect.ProtoMessage {
	return (*MsgUpdateTrustedOracles)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgUpdateTrustedOracles) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Sender != "" {
		value := protoreflect.ValueOfString(x.Sender)
		if !f(fd_MsgUpdateTrustedOracles_sender, value) {
			return
		}
	}
	if len(x.Oracles) != 0 {
		value := protoreflect.ValueOfList(&_MsgUpdateTrustedOracles_2_list{list: &x.Oracles})
		if !f(fd_MsgUpdateTrustedOracles_oracles, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgUpdateTrustedOracles) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "side.btcbridge.MsgUpdateTrustedOracles.sender":
		return x.Sender != ""
	case "side.btcbridge.MsgUpdateTrustedOracles.oracles":
		return len(x.Oracles) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgUpdateTrustedOracles"))
		}
		panic(fmt.Errorf("message side.btcbridge.MsgUpdateTrustedOracles does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgUpdateTrustedOracles) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "side.btcbridge.MsgUpdateTrustedOracles.sender":
		x.Sender = ""
	case "side.btcbridge.MsgUpdateTrustedOracles.oracles":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgUpdateTrustedOracles) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "side.btcbridge.MsgUpdateTrustedOracles.sender":
		value := x.Sender
		return protoreflect.ValueOfString(value)
	case "side.btcbridge.MsgUpdateTrustedOracles.oracles":
		if len(x.Oracles) == 0 {
			return protoreflect.ValueOfList(&_MsgUpdateTrustedOracles_2_list{})
		}
		listValue := &_MsgUpdateTrustedOracles_2_list{list: &x.Oracles}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgUpdateTrustedOracles"))
		}
		panic(fmt.Errorf("message side.btcbridge.MsgUpdateTrustedOracles does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgUpdateTrustedOracles) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "side.btcbridge.MsgUpdateTrustedOracles.sender":
		x.Sender = value.Interface().(string)
	case "side.btcbridge.MsgUpdateTrustedOracles.oracles":
		lv := value.List()
		clv := lv.(*_MsgUpdateTrustedOracles_2_list)
		x.Oracles = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgUpdateTrustedOracles"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgUpdateTrustedOracles) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "side.btcbridge.MsgUpdateTrustedOracles.oracles":
		if x.Oracles == nil {
			x.Oracles = []string{}
		}
		value := &_MsgUpdateTrustedOracles_2_list{list: &x.Oracles}
		return protoreflect.ValueOfList(value)
	case "side.btcbridge.MsgUpdateTrustedOracles.sender":
		panic(fmt.Errorf("field sender of message side.btcbridge.MsgUpdateTrustedOracles is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgUpdateTrustedOracles"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgUpdateTrustedOracles) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "side.btcbridge.MsgUpdateTrustedOracles.sender":
		return protoreflect.ValueOfString("")
	case "side.btcbridge.MsgUpdateTrustedOracles.oracles":
		list := []string{}
		return protoreflect.ValueOfList(&_MsgUpdateTrustedOracles_2_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgUpdateTrustedOracles"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgUpdateTrustedOracles) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in side.btcbridge.MsgUpdateTrustedOracles", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgUpdateTrustedOracles) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgUpdateTrustedOracles) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgUpdateTrustedOracles) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgUpdateTrustedOracles) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgUpdateTrustedOracles)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgUpdateTrustedOracles: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgUpdateTrustedOracles: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var (
	md_MsgUpdateTrustedOraclesResponse protoreflect.MessageDescriptor
)

func init() {
	file_side_btcbridge_tx_proto_init()
	md_MsgUpdateTrustedOraclesResponse = File_side_btcbridge_tx_proto.Messages().ByName("MsgUpdateTrustedOraclesResponse")
}

var _ protoreflect.Message = (*fastReflection_MsgUpdateTrustedOraclesResponse)(nil)

type fastReflection_MsgUpdateTrustedOraclesResponse MsgUpdateTrustedOraclesResponse

func (x *MsgUpdateTrustedOraclesResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgUpdateTrustedOraclesResponse)(x)
}

func (x *MsgUpdateTrustedOraclesResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_MsgUpdateTrustedOraclesResponse_messageType fastReflection_MsgUpdateTrustedOraclesResponse_messageType
var _ protoreflect.MessageType = fastReflection_MsgUpdateTrustedOraclesResponse_messageType{}

type fastReflection_MsgUpdateTrustedOraclesResponse_messageType struct{}

func (x fastReflection_MsgUpdateTrustedOraclesResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgUpdateTrustedOraclesResponse)(nil)
}
func (x fastReflection_MsgUpdateTrustedOraclesResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgUpdateTrustedOraclesResponse)
}
func (x fastReflection_MsgUpdateTrustedOraclesResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgUpdateTrustedOraclesResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgUpdateTrustedOraclesResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgUpdateTrustedOraclesResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgUpdateTrustedOraclesResponse) Type() protoreflect.MessageType {
	return _fastReflection_MsgUpdateTrustedOraclesResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgUpdateTrustedOraclesResponse) New() protoreflect.Message {
	return new(fastReflection_MsgUpdateTrustedOraclesResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgUpdateTrustedOraclesResponse) Interface() protoreflect.ProtoMessage {
	return (*MsgUpdateTrustedOraclesResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgUpdateTrustedOraclesResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgUpdateTrustedOraclesResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgUpdateTrustedOraclesResponse"))
		}
		panic(fmt.Errorf("message side.btcbridge.MsgUpdateTrustedOraclesResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgUpdateTrustedOraclesResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgUpdateTrustedOraclesResponse"))
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgUpdateTrustedOraclesResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgUpdateTrustedOraclesResponse"))
		}
		panic(fmt.Errorf("message side.btcbridge.MsgUpdateTrustedOraclesResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgUpdateTrustedOraclesResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgUpdateTrustedOraclesResponse"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgUpdateTrustedOraclesResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgUpdateTrustedOraclesResponse"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgUpdateTrustedOraclesResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgUpdateTrustedOraclesResponse"))
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgUpdateTrustedOraclesResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in side.btcbridge.MsgUpdateTrustedOraclesResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgUpdateTrustedOraclesResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgUpdateTrustedOraclesResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgUpdateTrustedOraclesResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgUpdateTrustedOraclesResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgUpdateTrustedOraclesResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgUpdateTrustedOraclesResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgUpdateTrustedOraclesResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			default:
				iNdEx = preIndex
...
var (
	md_MsgTerminateSigningRequests               protoreflect.MessageDescriptor
	fd_MsgTerminateSigningRequests_authority     protoreflect.FieldDescriptor
	fd_MsgTerminateSigningRequests_vault_version protoreflect.FieldDescriptor
)

func init() {
	file_side_btcbridge_tx_proto_init()
	md_MsgTerminateSigningRequests = File_side_btcbridge_tx_proto.Messages().ByName("MsgTerminateSigningRequests")
	fd_MsgTerminateSigningRequests_authority = md_MsgTerminateSigningRequests.Fields().ByName("authority")
	fd_MsgTerminateSigningRequests_vault_version = md_MsgTerminateSigningRequests.Fields().ByName("vault_version")
}

var _ protoreflect.Message = (*fastReflection_MsgTerminateSigningRequests)(nil)

type fastReflection_MsgTerminateSigningRequests MsgTerminateSigningRequests

func (x *MsgTerminateSigningRequests) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgTerminateSigningRequests)(x)
}

func (x *MsgTerminateSigningRequests) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_MsgTerminateSigningRequests_messageType fastReflection_MsgTerminateSigningRequests_messageType
var _ protoreflect.MessageType = fastReflection_MsgTerminateSigningRequests_messageType{}

type fastReflection_MsgTerminateSigningRequests_messageType struct{}

func (x fastReflection_MsgTerminateSigningRequests_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgTerminateSigningRequests)(nil)
}
func (x fastReflection_MsgTerminateSigningRequests_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgTerminateSigningRequests)
}
func (x fastReflection_MsgTerminateSigningRequests_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgTerminateSigningRequests
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgTerminateSigningRequests) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgTerminateSigningRequests
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgTerminateSigningRequests) Type() protoreflect.MessageType {
	return _fastReflection_MsgTerminateSigningRequests_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgTerminateSigningRequests) New() protoreflect.Message {
	return new(fastReflection_MsgTerminateSigningRequests)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgTerminateSigningRequests) Interface() protoreflect.ProtoMessage {
	return (*MsgTerminateSigningRequests)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgTerminateSigningRequests) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Authority != "" {
		value := protoreflect.ValueOfString(x.Authority)
		if !f(fd_MsgTerminateSigningRequests_authority, value) {
			return
		}
	}
	if x.VaultVersion != uint64(0) {
		value := protoreflect.ValueOfUint64(x.VaultVersion)
		if !f(fd_MsgTerminateSigningRequests_vault_version, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgTerminateSigningRequests) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "side.btcbridge.MsgTerminateSigningRequests.authority":
		return x.Authority != ""
	case "side.btcbridge.MsgTerminateSigningRequests.vault_version":
		return x.VaultVersion != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgTerminateSigningRequests"))
		}
		panic(fmt.Errorf("message side.btcbridge.MsgTerminateSigningRequests does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgTerminateSigningRequests) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "side.btcbridge.MsgTerminateSigningRequests.authority":
		x.Authority = ""
	case "side.btcbridge.MsgTerminateSigningRequests.vault_version":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgTerminateSigningRequests) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "side.btcbridge.MsgTerminateSigningRequests.authority":
		value := x.Authority
		return protoreflect.ValueOfString(value)
	...
	default:
		...
		panic(fmt.Errorf("message side.btcbridge.MsgTerminateSigningRequests does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgTerminateSigningRequests) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "side.btcbridge.MsgTerminateSigningRequests.authority":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgTerminateSigningRequests) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "side.btcbridge.MsgTerminateSigningRequests.authority":
		panic(fmt.Errorf("field authority of message side.btcbridge.MsgTerminateSigningRequests is not mutable"))
	case "side.btcbridge.MsgTerminateSigningRequests.vault_version":
		panic(fmt.Errorf("field vault_version of message side.btcbridge.MsgTerminateSigningRequests is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgTerminateSigningRequests"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgTerminateSigningRequests) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "side.btcbridge.MsgTerminateSigningRequests.authority":
		return protoreflect.ValueOfString("")
	case "side.btcbridge.MsgTerminateSigningRequests.vault_version":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgTerminateSigningRequests) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in side.btcbridge.MsgTerminateSigningRequests", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgTerminateSigningRequests) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgTerminateSigningRequests) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgTerminateSigningRequests) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgTerminateSigningRequests) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgTerminateSigningRequests)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgTerminateSigningRequests: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgTerminateSigningRequests: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var (
	md_MsgTerminateSigningRequestsResponse protoreflect.MessageDescriptor
)

func init() {
	file_side_btcbridge_tx_proto_init()
	md_MsgTerminateSigningRequestsResponse = File_side_btcbridge_tx_proto.Messages().ByName("MsgTerminateSigningRequestsResponse")
}

var _ protoreflect.Message = (*fastReflection_MsgTerminateSigningRequestsResponse)(nil)

type fastReflection_MsgTerminateSigningRequestsResponse MsgTerminateSigningRequestsResponse

func (x *MsgTerminateSigningRequestsResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MsgTerminateSigningRequestsResponse)(x)
}

func (x *MsgTerminateSigningRequestsResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_MsgTerminateSigningRequestsResponse_messageType fastReflection_MsgTerminateSigningRequestsResponse_messageType
var _ protoreflect.MessageType = fastReflection_MsgTerminateSigningRequestsResponse_messageType{}

type fastReflection_MsgTerminateSigningRequestsResponse_messageType struct{}

func (x fastReflection_MsgTerminateSigningRequestsResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MsgTerminateSigningRequestsResponse)(nil)
}
func (x fastReflection_MsgTerminateSigningRequestsResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_MsgTerminateSigningRequestsResponse)
}
func (x fastReflection_MsgTerminateSigningRequestsResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgTerminateSigningRequestsResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MsgTerminateSigningRequestsResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_MsgTerminateSigningRequestsResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MsgTerminateSigningRequestsResponse) Type() protoreflect.MessageType {
	return _fastReflection_MsgTerminateSigningRequestsResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MsgTerminateSigningRequestsResponse) New() protoreflect.Message {
	return new(fastReflection_MsgTerminateSigningRequestsResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MsgTerminateSigningRequestsResponse) Interface() protoreflect.ProtoMessage {
	return (*MsgTerminateSigningRequestsResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MsgTerminateSigningRequestsResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MsgTerminateSigningRequestsResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgTerminateSigningRequestsResponse"))
		}
		panic(fmt.Errorf("message side.btcbridge.MsgTerminateSigningRequestsResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgTerminateSigningRequestsResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgTerminateSigningRequestsResponse"))
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MsgTerminateSigningRequestsResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgTerminateSigningRequestsResponse"))
		}
		panic(fmt.Errorf("message side.btcbridge.MsgTerminateSigningRequestsResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgTerminateSigningRequestsResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgTerminateSigningRequestsResponse"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgTerminateSigningRequestsResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgTerminateSigningRequestsResponse"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MsgTerminateSigningRequestsResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgTerminateSigningRequestsResponse"))
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MsgTerminateSigningRequestsResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in side.btcbridge.MsgTerminateSigningRequestsResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MsgTerminateSigningRequestsResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MsgTerminateSigningRequestsResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MsgTerminateSigningRequestsResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MsgTerminateSigningRequestsResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MsgTerminateSigningRequestsResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgTerminateSigningRequestsResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MsgTerminateSigningRequestsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			default:
				iNdEx = preIndex
...
var _ protoreflect.List = (*_MsgConsolidateVaults_5_list)(nil)

type _MsgConsolidateVaults_5_list struct {
	list *[]*RunesConsolidation
}

func (x *_MsgConsolidateVaults_5_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_MsgConsolidateVaults_5_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_MsgConsolidateVaults_5_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*RunesConsolidation)
	(*x.list)[i] = concreteValue
}

func (x *_MsgConsolidateVaults_5_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*RunesConsolidation)
	*x.list = append(*x.list, concreteValue)
}

func (x *_MsgConsolidateVaults_5_list) AppendMutable() protoreflect.Value {
	v := new(RunesConsolidation)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_MsgConsolidateVaults_5_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_MsgConsolidateVaults_5_list) NewElement() protoreflect.Value {
	v := new(RunesConsolidation)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_MsgConsolidateVaults_5_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_MsgConsolidateVaults_fee_rate             protoreflect.FieldDescriptor
...
func init() {
	...
	fd_MsgConsolidateVaults_fee_rate = md_MsgConsolidateVaults.Fields().ByName("fee_rate")
...
func (x *fastReflection_MsgConsolidateVaults) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.FeeRate != int64(0) {
		value := protoreflect.ValueOfInt64(x.FeeRate)
		if !f(fd_MsgConsolidateVaults_fee_rate, value) {
			return
		}
	}
	...
	if len(x.RunesConsolidations) != 0 {
		value := protoreflect.ValueOfList(&_MsgConsolidateVaults_5_list{list: &x.RunesConsolidations})
...
func (x *fastReflection_MsgConsolidateVaults) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "side.btcbridge.MsgConsolidateVaults.vault_version":
		return x.VaultVersion != uint64(0)
	case "side.btcbridge.MsgConsolidateVaults.fee_rate":
		return x.FeeRate != int64(0)
...
func (x *fastReflection_MsgConsolidateVaults) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "side.btcbridge.MsgConsolidateVaults.runes_consolidations":
		if len(x.RunesConsolidations) == 0 {
			return protoreflect.ValueOfList(&_MsgConsolidateVaults_5_list{})
		}
		listValue := &_MsgConsolidateVaults_5_list{list: &x.RunesConsolidations}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgConsolidateVaults"))
...
func (x *fastReflection_MsgConsolidateVaults) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "side.btcbridge.MsgConsolidateVaults.runes_consolidations":
		lv := value.List()
		clv := lv.(*_MsgConsolidateVaults_5_list)
...
func (x *fastReflection_MsgConsolidateVaults) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "side.btcbridge.MsgConsolidateVaults.runes_consolidations":
		...
		value := &_MsgConsolidateVaults_5_list{list: &x.RunesConsolidations}
		return protoreflect.ValueOfList(value)
	case "side.btcbridge.MsgConsolidateVaults.authority":
	...
	case "side.btcbridge.MsgConsolidateVaults.fee_rate":
		panic(fmt.Errorf("field fee_rate of message side.btcbridge.MsgConsolidateVaults is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgConsolidateVaults"))
		}
...
func (x *fastReflection_MsgConsolidateVaults) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "side.btcbridge.MsgConsolidateVaults.runes_consolidations":
		list := []*RunesConsolidation{}
		return protoreflect.ValueOfList(&_MsgConsolidateVaults_5_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgConsolidateVaults"))
		}
...
var (
	...
	fd_MsgInitiateDKG_disable_bridge  protoreflect.FieldDescriptor
	...
	fd_MsgInitiateDKG_fee_rate        protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MsgInitiateDKG_disable_bridge = md_MsgInitiateDKG.Fields().ByName("disable_bridge")
	...
	fd_MsgInitiateDKG_fee_rate = md_MsgInitiateDKG.Fields().ByName("fee_rate")
}
...
func (x *fastReflection_MsgInitiateDKG) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.DisableBridge != false {
		...
		if !f(fd_MsgInitiateDKG_disable_bridge, value) {
			return
		}
	}
	...
	if x.FeeRate != "" {
		...
		if !f(fd_MsgInitiateDKG_fee_rate, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgInitiateDKG) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "side.btcbridge.MsgInitiateDKG.disable_bridge":
	...
	case "side.btcbridge.MsgInitiateDKG.fee_rate":
		return x.FeeRate != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_MsgInitiateDKG) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "side.btcbridge.MsgInitiateDKG.disable_bridge":
		panic(fmt.Errorf("field disable_bridge of message side.btcbridge.MsgInitiateDKG is not mutable"))
	case "side.btcbridge.MsgInitiateDKG.enable_transfer":
	...
	case "side.btcbridge.MsgInitiateDKG.fee_rate":
		panic(fmt.Errorf("field fee_rate of message side.btcbridge.MsgInitiateDKG is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgInitiateDKG"))
		}
...
var (
	...
	fd_MsgTransferVault_fee_rate        protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MsgTransferVault_fee_rate = md_MsgTransferVault.Fields().ByName("fee_rate")
}
...
func (x *fastReflection_MsgTransferVault) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.FeeRate != "" {
		value := protoreflect.ValueOfString(x.FeeRate)
		if !f(fd_MsgTransferVault_fee_rate, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgTransferVault) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "side.btcbridge.MsgTransferVault.target_utxo_num":
		return x.TargetUtxoNum != uint32(0)
	case "side.btcbridge.MsgTransferVault.fee_rate":
		return x.FeeRate != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_MsgTransferVault) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "side.btcbridge.MsgTransferVault.fee_rate":
		panic(fmt.Errorf("field fee_rate of message side.btcbridge.MsgTransferVault is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.btcbridge.MsgTransferVault"))
		}
...
func (x *MsgUpdateTrustedOraclesResponse) Reset() {
	*x = MsgUpdateTrustedOraclesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_side_btcbridge_tx_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *MsgTerminateSigningRequestsResponse) Reset() {
	*x = MsgTerminateSigningRequestsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_side_btcbridge_tx_proto_msgTypes[17]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
type MsgConsolidateVaults struct {
	...
	// btc consolidation
	BtcConsolidation *BtcConsolidation `protobuf:"bytes,4,opt,name=btc_consolidation,json=btcConsolidation,proto3" json:"btc_consolidation,omitempty"`
	// runes consolidations
	RunesConsolidations []*RunesConsolidation `protobuf:"bytes,5,rep,name=runes_consolidations,json=runesConsolidations,proto3" json:"runes_consolidations,omitempty"`
}
...
func (x *MsgConsolidateVaults) GetFeeRate() int64 {
	if x != nil {
		return x.FeeRate
	}
	return 0
...
func (x *MsgInitiateDKG) GetDisableBridge() bool {
	if x != nil {
...
func (x *MsgInitiateDKG) GetFeeRate() string {
	if x != nil {
		return x.FeeRate
	}
	return ""
...
func (x *MsgTransferVault) GetFeeRate() string {
	if x != nil {
		return x.FeeRate
	}
	return ""
...
var file_side_btcbridge_tx_proto_rawDesc = []byte{
	...
	,
	...
	0x72, 0x22, 0x1e, 0x0a, 0x1c, 0x4d, 0x73, 0x67, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77,
	0x54, 0x6f, 0x42, 0x69, 0x74, 0x63, 0x6f, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x22, 0x62, 0x0a, 0x13, 0x4d, 0x73, 0x67, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x53, 0x69,
	...
	0x74, 0x78, 0x69, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x73, 0x62, 0x74, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x70, 0x73, 0x62, 0x74, 0x3a, 0x0b, 0x82, 0xe7, 0xb0, 0x2a, 0x06, 0x73,
	...
	,
	...
	0x73, 0x6f, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28,
	...
	0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xef, 0x02, 0x0a, 0x0e, 0x4d,
	...
	,
	...
	0x64, 0x12, 0x16, 0x0a, 0x06, 0x76, 0x61, 0x75, 0x6c, 0x74, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28,
	0x09, 0x52, 0x06, 0x76, 0x61, 0x75, 0x6c, 0x74, 0x73, 0x12, 0x2b, 0x0a, 0x11, 0x63, 0x6f, 0x6e,
	0x73, 0x65, 0x6e, 0x73, 0x75, 0x73, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x63, 0x6f, 0x6e, 0x73, 0x65, 0x6e, 0x73, 0x75, 0x73, 0x41,
	...
	0x72, 0x22, 0x18, 0x0a, 0x16, 0x4d, 0x73, 0x67, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65,
	0x44, 0x4b, 0x47, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x9d, 0x02, 0x0a, 0x10,
	...
	,
	...
	0x12, 0x19, 0x0a, 0x08, 0x66, 0x65, 0x65, 0x5f, 0x72, 0x61, 0x74, 0x65, 0x18, 0x07, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x07, 0x66, 0x65, 0x65, 0x52, 0x61, 0x74, 0x65, 0x3a, 0x0e, 0x82, 0xe7, 0xb0,
	0x2a, 0x09, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x22, 0x1a, 0x0a, 0x18, 0x4d,
	0x73, 0x67, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x56, 0x61, 0x75, 0x6c, 0x74, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x75, 0x0a, 0x0f, 0x4d, 0x73, 0x67, 0x55, 0x70,
	...
	0x6d, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x73, 0x69, 0x64, 0x65, 0x2e,
	0x62, 0x74, 0x63, 0x62, 0x72, 0x69, 0x64, 0x67, 0x65, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73,
	...
	,
	...
	,
	...
	0x80, 0xe7, 0xb0, 0x2a, 0x01, 0x42, 0x97, 0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x69,
	...
	0x64, 0x6b, 0x2e, 0x69, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x73, 0x69, 0x64, 0x65, 0x2f, 0x62,
...
var file_side_btcbridge_tx_proto_goTypes = []interface{}{
	...
	(*MsgUpdateTrustedOracles)(nil),                // 10: side.btcbridge.MsgUpdateTrustedOracles
	(*MsgUpdateTrustedOraclesResponse)(nil),        // 11: side.btcbridge.MsgUpdateTrustedOraclesResponse
	...
	(*MsgTerminateSigningRequests)(nil),            // 16: side.btcbridge.MsgTerminateSigningRequests
	(*MsgTerminateSigningRequestsResponse)(nil),    // 17: side.btcbridge.MsgTerminateSigningRequestsResponse
	(*MsgConsolidateVaults)(nil),                   // 18: side.btcbridge.MsgConsolidateVaults
	(*MsgConsolidateVaultsResponse)(nil),           // 19: side.btcbridge.MsgConsolidateVaultsResponse
	(*MsgInitiateDKG)(nil),                         // 20: side.btcbridge.MsgInitiateDKG
	(*MsgInitiateDKGResponse)(nil),                 // 21: side.btcbridge.MsgInitiateDKGResponse
	(*MsgCompleteDKG)(nil),                         // 22: side.btcbridge.MsgCompleteDKG
	(*MsgCompleteDKGResponse)(nil),                 // 23: side.btcbridge.MsgCompleteDKGResponse
	...
	(*BlockHeader)(nil),                            // 28: side.btcbridge.BlockHeader
	(*BtcConsolidation)(nil),                       // 29: side.btcbridge.BtcConsolidation
	(*RunesConsolidation)(nil),                     // 30: side.btcbridge.RunesConsolidation
	(*DKGParticipant)(nil),                         // 31: side.btcbridge.DKGParticipant
	(AssetType)(0),                                 // 32: side.btcbridge.AssetType
	(*Params)(nil),                                 // 33: side.btcbridge.Params
}
var file_side_btcbridge_tx_proto_depIdxs = []int32{
	28, // 0: side.btcbridge.MsgSubmitBlockHeaders.block_headers:type_name -> side.btcbridge.BlockHeader
	29, // 1: side.btcbridge.MsgConsolidateVaults.btc_consolidation:type_name -> side.btcbridge.BtcConsolidation
	30, // 2: side.btcbridge.MsgConsolidateVaults.runes_consolidations:type_name -> side.btcbridge.RunesConsolidation
	31, // 3: side.btcbridge.MsgInitiateDKG.participants:type_name -> side.btcbridge.DKGParticipant
	32, // 4: side.btcbridge.MsgInitiateDKG.vault_types:type_name -> side.btcbridge.AssetType
	32, // 5: side.btcbridge.MsgTransferVault.asset_type:type_name -> side.btcbridge.AssetType
	...
	10, // 12: side.btcbridge.Msg.UpdateTrustedOracles:input_type -> side.btcbridge.MsgUpdateTrustedOracles
	...
	16, // 15: side.btcbridge.Msg.TerminateSigningRequests:input_type -> side.btcbridge.MsgTerminateSigningRequests
	18, // 16: side.btcbridge.Msg.ConsolidateVaults:input_type -> side.btcbridge.MsgConsolidateVaults
	20, // 17: side.btcbridge.Msg.InitiateDKG:input_type -> side.btcbridge.MsgInitiateDKG
	22, // 18: side.btcbridge.Msg.CompleteDKG:input_type -> side.btcbridge.MsgCompleteDKG
	...
	1,  // 21: side.btcbridge.Msg.SubmitBlockHeaders:output_type -> side.btcbridge.MsgSubmitBlockHeadersResponse
	3,  // 22: side.btcbridge.Msg.SubmitDepositTransaction:output_type -> side.btcbridge.MsgSubmitDepositTransactionResponse
	5,  // 23: side.btcbridge.Msg.SubmitWithdrawTransaction:output_type -> side.btcbridge.MsgSubmitWithdrawTransactionResponse
	7,  // 24: side.btcbridge.Msg.SubmitFeeRate:output_type -> side.btcbridge.MsgSubmitFeeRateResponse
	9,  // 25: side.btcbridge.Msg.UpdateTrustedNonBtcRelayers:output_type -> side.btcbridge.MsgUpdateTrustedNonBtcRelayersResponse
	11, // 26: side.btcbridge.Msg.UpdateTrustedOracles:output_type -> side.btcbridge.MsgUpdateTrustedOraclesResponse
	13, // 27: side.btcbridge.Msg.WithdrawToBitcoin:output_type -> side.btcbridge.MsgWithdrawToBitcoinResponse
	15, // 28: side.btcbridge.Msg.SubmitSignatures:output_type -> side.btcbridge.MsgSubmitSignaturesResponse
	17, // 29: side.btcbridge.Msg.TerminateSigningRequests:output_type -> side.btcbridge.MsgTerminateSigningRequestsResponse
	19, // 30: side.btcbridge.Msg.ConsolidateVaults:output_type -> side.btcbridge.MsgConsolidateVaultsResponse
	21, // 31: side.btcbridge.Msg.InitiateDKG:output_type -> side.btcbridge.MsgInitiateDKGResponse
	23, // 32: side.btcbridge.Msg.CompleteDKG:output_type -> side.btcbridge.MsgCompleteDKGResponse
...
func file_side_btcbridge_tx_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_side_btcbridge_tx_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgUpdateTrustedOracles); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_side_btcbridge_tx_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgUpdateTrustedOraclesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_side_btcbridge_tx_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgTerminateSigningRequests); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_side_btcbridge_tx_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgTerminateSigningRequestsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
