...
var (
	...
	fd_MsgCompleteDKG_participant protoreflect.FieldDescriptor
...
func init() {
	...
	fd_MsgCompleteDKG_participant = md_MsgCompleteDKG.Fields().ByName("participant")
...
func (x *fastReflection_MsgCompleteDKG) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Participant != "" {
		...
		if !f(fd_MsgCompleteDKG_participant, value) {
			return
		}
	}
	if x.Signature != "" {
...
func (x *fastReflection_MsgCompleteDKG) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "side.tss.MsgCompleteDKG.participant":
...
func (x *fastReflection_MsgCompleteDKG) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "side.tss.MsgCompleteDKG.participant":
		panic(fmt.Errorf("field participant of message side.tss.MsgCompleteDKG is not mutable"))
	case "side.tss.MsgCompleteDKG.signature":
...
func (x *MsgCompleteDKG) GetParticipant() string {
	if x != nil {
		return x.Participant
	}
	return ""
...
var file_side_tss_tx_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xa0, 0x01, 0x0a, 0x0e, 0x4d, 0x73, 0x67, 0x43, 0x6f, 0x6d, 0x70, 0x6c,
	...
	0x52, 0x07, 0x70, 0x75, 0x62, 0x4b, 0x65, 0x79, 0x73, 0x12, 0x20, 0x0a, 0x0b, 0x70, 0x61, 0x72,
	0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b,
	0x70, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x73,
	...
	0x22, 0x6a, 0x0a, 0x13, 0x4d, 0x73, 0x67, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x53, 0x69, 0x67,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xff, 0x01, 0x0a, 0x03, 0x4d, 0x73, 0x67, 0x12,
...
var file_side_tss_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_side_tss_tx_proto_goTypes = []interface{}{
	...
	(*MsgUpdateParams)(nil),             // 4: side.tss.MsgUpdateParams
	(*MsgUpdateParamsResponse)(nil),     // 5: side.tss.MsgUpdateParamsResponse
	(*Params)(nil),                      // 6: side.tss.Params
}
var file_side_tss_tx_proto_depIdxs = []int32{
	6, // 0: side.tss.MsgUpdateParams.params:type_name -> side.tss.Params
	...
	4, // 3: side.tss.Msg.UpdateParams:input_type -> side.tss.MsgUpdateParams
	1, // 4: side.tss.Msg.CompleteDKG:output_type -> side.tss.MsgCompleteDKGResponse
	3, // 5: side.tss.Msg.SubmitSignatures:output_type -> side.tss.MsgSubmitSignaturesResponse
	5, // 6: side.tss.Msg.UpdateParams:output_type -> side.tss.MsgUpdateParamsResponse
