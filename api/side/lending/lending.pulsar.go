...
var file_side_lending_lending_proto_rawDesc = []byte{
	...
	0x4e, 0x54, 0x10, 0x02, 0x42, 0xa0, 0x01, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x69, 0x64,
...
var file_side_lending_lending_proto_depIdxs = []int32{
	...
	14, // 6: side.lending.Loan.disburse_at:type_name -> google.protobuf.Timestamp
	1,  // 7: side.lending.Loan.status:type_name -> side.lending.LoanStatus
	7,  // 8: side.lending.DLCMeta.liquidation_cet:type_name -> side.lending.LiquidationCet
	7,  // 9: side.lending.DLCMeta.default_liquidation_cet:type_name -> side.lending.LiquidationCet
	8,  // 10: side.lending.DLCMeta.repayment_cet:type_name -> side.lending.RepaymentCet
	15, // 11: side.lending.DLCMeta.vault_utxos:type_name -> side.btcbridge.UTXO
	13, // 12: side.lending.Repayment.amount:type_name -> cosmos.base.v1beta1.Coin
	14, // 13: side.lending.Repayment.create_at:type_name -> google.protobuf.Timestamp
	14, // 14: side.lending.Cancellation.create_at:type_name -> google.protobuf.Timestamp
