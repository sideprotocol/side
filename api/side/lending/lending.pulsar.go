...
var file_side_lending_lending_proto_rawDesc = []byte{
	...
	0x54, 0x10, 0x02, 0x42, 0xa0, 0x01, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x69, 0x64, 0x65,
...
var file_side_lending_lending_proto_goTypes = []interface{}{
	...
	(*PoolTrancheConfig)(nil),     // 3: side.lending.PoolTrancheConfig
	(*PoolConfig)(nil),            // 4: side.lending.PoolConfig
	(*PoolTranche)(nil),           // 5: side.lending.PoolTranche
	(*LendingPool)(nil),           // 6: side.lending.LendingPool
	(*AuthorizationDeposits)(nil), // 7: side.lending.AuthorizationDeposits
	(*Loan)(nil),                  // 8: side.lending.Loan
	(*CetInfo)(nil),               // 9: side.lending.CetInfo
	(*LiquidationCet)(nil),        // 10: side.lending.LiquidationCet
	(*RepaymentCet)(nil),          // 11: side.lending.RepaymentCet
	(*DLCMeta)(nil),               // 12: side.lending.DLCMeta
	(*DepositLog)(nil),            // 13: side.lending.DepositLog
	(*Repayment)(nil),             // 14: side.lending.Repayment
	(*Cancellation)(nil),          // 15: side.lending.Cancellation
	(*v1beta1.Coin)(nil),          // 16: cosmos.base.v1beta1.Coin
	(*timestamppb.Timestamp)(nil), // 17: google.protobuf.Timestamp
	(*btcbridge.UTXO)(nil),        // 18: side.btcbridge.UTXO
}
var file_side_lending_lending_proto_depIdxs = []int32{
	3,  // 0: side.lending.PoolConfig.tranches:type_name -> side.lending.PoolTrancheConfig
	16, // 1: side.lending.PoolConfig.request_fee:type_name -> cosmos.base.v1beta1.Coin
	16, // 2: side.lending.LendingPool.supply:type_name -> cosmos.base.v1beta1.Coin
	16, // 3: side.lending.LendingPool.total_stokens:type_name -> cosmos.base.v1beta1.Coin
	5,  // 4: side.lending.LendingPool.tranches:type_name -> side.lending.PoolTranche
	4,  // 5: side.lending.LendingPool.config:type_name -> side.lending.PoolConfig
	0,  // 6: side.lending.LendingPool.status:type_name -> side.lending.PoolStatus
	16, // 7: side.lending.Loan.borrow_amount:type_name -> cosmos.base.v1beta1.Coin
	16, // 8: side.lending.Loan.request_fee:type_name -> cosmos.base.v1beta1.Coin
	7,  // 9: side.lending.Loan.authorization_deposits:type_name -> side.lending.AuthorizationDeposits
	17, // 10: side.lending.Loan.create_at:type_name -> google.protobuf.Timestamp
	17, // 11: side.lending.Loan.disburse_at:type_name -> google.protobuf.Timestamp
	1,  // 12: side.lending.Loan.status:type_name -> side.lending.LoanStatus
	10, // 13: side.lending.DLCMeta.liquidation_cet:type_name -> side.lending.LiquidationCet
	10, // 14: side.lending.DLCMeta.default_liquidation_cet:type_name -> side.lending.LiquidationCet
	11, // 15: side.lending.DLCMeta.repayment_cet:type_name -> side.lending.RepaymentCet
	18, // 16: side.lending.DLCMeta.vault_utxos:type_name -> side.btcbridge.UTXO
	16, // 17: side.lending.Repayment.amount:type_name -> cosmos.base.v1beta1.Coin
	17, // 18: side.lending.Repayment.create_at:type_name -> google.protobuf.Timestamp
	17, // 19: side.lending.Cancellation.create_at:type_name -> google.protobuf.Timestamp
