...
var file_side_lending_query_proto_rawDesc = []byte{
	...
	0x65, 0x32, 0xc8, 0x0f, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x6b, 0x0a, 0x06, 0x50,
...
var file_side_lending_query_proto_depIdxs = []int32{
	...
	13, // 38: side.lending.Query.Params:output_type -> side.lending.QueryParamsResponse
	1,  // 39: side.lending.Query.Pool:output_type -> side.lending.QueryPoolResponse
	3,  // 40: side.lending.Query.Pools:output_type -> side.lending.QueryPoolsResponse
	5,  // 41: side.lending.Query.PoolExchangeRate:output_type -> side.lending.QueryPoolExchangeRateResponse
	11, // 42: side.lending.Query.CollateralAddress:output_type -> side.lending.QueryCollateralAddressResponse
	7,  // 43: side.lending.Query.LiquidationEvent:output_type -> side.lending.QueryLiquidationEventResponse
	15, // 44: side.lending.Query.Loan:output_type -> side.lending.QueryLoanResponse
	17, // 45: side.lending.Query.Loans:output_type -> side.lending.QueryLoansResponse
	19, // 46: side.lending.Query.LoansByAddress:output_type -> side.lending.QueryLoansByAddressResponse
	9,  // 47: side.lending.Query.LoanCetInfos:output_type -> side.lending.QueryLoanCetInfosResponse
	21, // 48: side.lending.Query.LoanDlcMeta:output_type -> side.lending.QueryLoanDlcMetaResponse
	23, // 49: side.lending.Query.LoanAuthorization:output_type -> side.lending.QueryLoanAuthorizationResponse
	25, // 50: side.lending.Query.Redemption:output_type -> side.lending.QueryRedemptionResponse
	27, // 51: side.lending.Query.Repayment:output_type -> side.lending.QueryRepaymentResponse
	29, // 52: side.lending.Query.CurrentInterest:output_type -> side.lending.QueryCurrentInterestResponse
