...
var file_side_liquidation_liquidation_proto_rawDesc = []byte{
	...
	0x5f, 0x53, 0x45, 0x54, 0x54, 0x4c, 0x45, 0x44, 0x10, 0x04, 0x42, 0xbc, 0x01, 0x0a, 0x14, 0x63,
	0x6f, 0x6d, 0x2e, 0x73, 0x69, 0x64, 0x65, 0x2e, 0x6c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x42, 0x10, 0x4c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x69, 0x71, 0x75, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0xa2, 0x02, 0x03, 0x53, 0x4c, 0x58,
	0xaa, 0x02, 0x10, 0x53, 0x69, 0x64, 0x65, 0x2e, 0x4c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0xca, 0x02, 0x10, 0x53, 0x69, 0x64, 0x65, 0x5c, 0x4c, 0x69, 0x71, 0x75, 0x69,
	0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0xe2, 0x02, 0x1c, 0x53, 0x69, 0x64, 0x65, 0x5c, 0x4c, 0x69,
	0x71, 0x75, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74,
	0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x11, 0x53, 0x69, 0x64, 0x65, 0x3a, 0x3a, 0x4c, 0x69,
	0x71, 0x75, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_side_liquidation_liquidation_proto_depIdxs = []int32{
	...
	4,  // 1: side.liquidation.Liquidation.actual_collateral_amount:type_name -> cosmos.base.v1beta1.Coin
	4,  // 2: side.liquidation.Liquidation.debt_amount:type_name -> cosmos.base.v1beta1.Coin
	5,  // 3: side.liquidation.Liquidation.liquidated_time:type_name -> google.protobuf.Timestamp
	4,  // 4: side.liquidation.Liquidation.liquidated_collateral_amount:type_name -> cosmos.base.v1beta1.Coin
	4,  // 5: side.liquidation.Liquidation.liquidated_debt_amount:type_name -> cosmos.base.v1beta1.Coin
	4,  // 6: side.liquidation.Liquidation.liquidation_bonus_amount:type_name -> cosmos.base.v1beta1.Coin
	4,  // 7: side.liquidation.Liquidation.protocol_liquidation_fee:type_name -> cosmos.base.v1beta1.Coin
	4,  // 8: side.liquidation.Liquidation.unliquidated_collateral_amount:type_name -> cosmos.base.v1beta1.Coin
	1,  // 9: side.liquidation.Liquidation.status:type_name -> side.liquidation.LiquidationStatus
	4,  // 10: side.liquidation.LiquidationRecord.debt_amount:type_name -> cosmos.base.v1beta1.Coin
	4,  // 11: side.liquidation.LiquidationRecord.collateral_amount:type_name -> cosmos.base.v1beta1.Coin
	4,  // 12: side.liquidation.LiquidationRecord.bonus_amount:type_name -> cosmos.base.v1beta1.Coin
	5,  // 13: side.liquidation.LiquidationRecord.time:type_name -> google.protobuf.Timestamp
