...
var (
	...
	fd_Params_min_liquidation_factor             protoreflect.FieldDescriptor
...
func init() {
	...
	fd_Params_min_liquidation_factor = md_Params.Fields().ByName("min_liquidation_factor")
...
func (x *Params) slowProtoReflect() protoreflect.Message {
	mi := &file_side_liquidation_params_proto_msgTypes[0]
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.MinLiquidationFactor != "" {
		value := protoreflect.ValueOfString(x.MinLiquidationFactor)
		if !f(fd_Params_min_liquidation_factor, value) {
			return
		}
	}
	if x.LiquidationBonusFactor != "" {
		value := protoreflect.ValueOfString(x.LiquidationBonusFactor)
		if !f(fd_Params_liquidation_bonus_factor, value) {
			return
		}
	}
	if x.ProtocolLiquidationFeeFactor != "" {
		value := protoreflect.ValueOfString(x.ProtocolLiquidationFeeFactor)
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "side.liquidation.Params.min_liquidation_factor":
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.liquidation.Params"))
		}
		panic(fmt.Errorf("message side.liquidation.Params does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Params) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "side.liquidation.Params.min_liquidation_factor":
		x.MinLiquidationFactor = ""
	case "side.liquidation.Params.liquidation_bonus_factor":
		x.LiquidationBonusFactor = ""
	case "side.liquidation.Params.protocol_liquidation_fee_factor":
		x.ProtocolLiquidationFeeFactor = ""
	case "side.liquidation.Params.protocol_liquidation_fee_collector":
...
func (x *fastReflection_Params) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message side.liquidation.Params does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Params) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "side.liquidation.Params.min_liquidation_factor":
		x.MinLiquidationFactor = value.Interface().(string)
	case "side.liquidation.Params.liquidation_bonus_factor":
		x.LiquidationBonusFactor = value.Interface().(string)
	case "side.liquidation.Params.protocol_liquidation_fee_factor":
		x.ProtocolLiquidationFeeFactor = value.Interface().(string)
	case "side.liquidation.Params.protocol_liquidation_fee_collector":
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "side.liquidation.Params.min_liquidation_factor":
		panic(fmt.Errorf("field min_liquidation_factor of message side.liquidation.Params is not mutable"))
	case "side.liquidation.Params.liquidation_bonus_factor":
...
func (x *fastReflection_Params) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in side.liquidation.Params", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		var l int
		_ = l
		l = len(x.MinLiquidationFactor)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		l = len(x.LiquidationBonusFactor)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
		l = len(x.ProtocolLiquidationFeeFactor)
		if l > 0 {
			n += 1 + l + runtime.Sov(uint64(l))
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.ProtocolLiquidationFeeFactor) > 0 {
			i -= len(x.ProtocolLiquidationFeeFactor)
			copy(dAtA[i:], x.ProtocolLiquidationFeeFactor)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.ProtocolLiquidationFeeFactor)))
			i--
			dAtA[i] = 0x1a
		}
		if len(x.LiquidationBonusFactor) > 0 {
			i -= len(x.LiquidationBonusFactor)
			copy(dAtA[i:], x.LiquidationBonusFactor)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.LiquidationBonusFactor)))
			i--
			dAtA[i] = 0x12
		}
		if len(x.MinLiquidationFactor) > 0 {
			i -= len(x.MinLiquidationFactor)
			copy(dAtA[i:], x.MinLiquidationFactor)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.MinLiquidationFactor)))
			i--
			dAtA[i] = 0xa
		}
		if input.Buf != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				...
				x.MinLiquidationFactor = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 2:
				if wireType != 2 {
				...
				x.LiquidationBonusFactor = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 3:
				if wireType != 2 {
				...
				x.ProtocolLiquidationFeeFactor = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 4:
				if wireType != 2 {
...
type Params struct {
	...
	MinLiquidationFactor string `protobuf:"bytes,1,opt,name=min_liquidation_factor,json=minLiquidationFactor,proto3" json:"min_liquidation_factor,omitempty"`
	// liquidation bonus factor
	LiquidationBonusFactor string `protobuf:"bytes,2,opt,name=liquidation_bonus_factor,json=liquidationBonusFactor,proto3" json:"liquidation_bonus_factor,omitempty"`
	// protocol liquidation fee factor
	ProtocolLiquidationFeeFactor string `protobuf:"bytes,3,opt,name=protocol_liquidation_fee_factor,json=protocolLiquidationFeeFactor,proto3" json:"protocol_liquidation_fee_factor,omitempty"`
...
func (x *Params) GetMinLiquidationFactor() string {
	if x != nil {
		return x.MinLiquidationFactor
	}
	return ""
...
func (x *Params) GetLiquidationBonusFactor() string {
	if x != nil {
		return x.LiquidationBonusFactor
	}
	return ""
...
func (x *Params) GetProtocolLiquidationFeeFactor() string {
	if x != nil {
		return x.ProtocolLiquidationFeeFactor
	}
	return ""
...
var file_side_liquidation_params_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x73, 0x69, 0x64, 0x65, 0x2f, 0x6c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x61, 0x74, 0x69,
	...
	,
	...
	0x0a, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x16, 0x6c, 0x69, 0x71,
	0x75, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x6f, 0x6e, 0x75, 0x73, 0x46, 0x61, 0x63,
	0x74, 0x6f, 0x72, 0x12, 0x78, 0x0a, 0x1f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x5f,
	0x6c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x66, 0x65, 0x65, 0x5f,
	0x66, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x31, 0xc8, 0xde,
	...
	0x1c, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x4c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x46, 0x65, 0x65, 0x46, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x4b, 0x0a,
	0x22, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x5f, 0x6c, 0x69, 0x71, 0x75, 0x69, 0x64,
...
var (
	file_side_liquidation_params_proto_rawDescOnce sync.Once
	file_side_liquidation_params_proto_rawDescData = file_side_liquidation_params_proto_rawDesc
)

func file_side_liquidation_params_proto_rawDescGZIP() []byte {
	file_side_liquidation_params_proto_rawDescOnce.Do(func() {
		file_side_liquidation_params_proto_rawDescData = protoimpl.X.CompressGZIP(file_side_liquidation_params_proto_rawDescData)
	})
...
func init() { file_side_liquidation_params_proto_init() }
func file_side_liquidation_params_proto_init() {
	if File_side_liquidation_params_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_side_liquidation_params_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Params); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_side_liquidation_params_proto_goTypes,
		DependencyIndexes: file_side_liquidation_params_proto_depIdxs,
		MessageInfos:      file_side_liquidation_params_proto_msgTypes,
	}.Build()
	File_side_liquidation_params_proto = out.File
	file_side_liquidation_params_proto_rawDesc = nil
	file_side_liquidation_params_proto_goTypes = nil
	file_side_liquidation_params_proto_depIdxs = nil
}
