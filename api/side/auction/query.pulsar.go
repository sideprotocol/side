...
var (
	md_QueryAuctionPriceRequest            protoreflect.MessageDescriptor
	fd_QueryAuctionPriceRequest_auction_id protoreflect.FieldDescriptor
)

func init() {
	file_side_auction_query_proto_init()
	md_QueryAuctionPriceRequest = File_side_auction_query_proto.Messages().ByName("QueryAuctionPriceRequest")
	fd_QueryAuctionPriceRequest_auction_id = md_QueryAuctionPriceRequest.Fields().ByName("auction_id")
}

var _ protoreflect.Message = (*fastReflection_QueryAuctionPriceRequest)(nil)

type fastReflection_QueryAuctionPriceRequest QueryAuctionPriceRequest

func (x *QueryAuctionPriceRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryAuctionPriceRequest)(x)
}

func (x *QueryAuctionPriceRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_side_auction_query_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_QueryAuctionPriceRequest_messageType fastReflection_QueryAuctionPriceRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryAuctionPriceRequest_messageType{}

type fastReflection_QueryAuctionPriceRequest_messageType struct{}

func (x fastReflection_QueryAuctionPriceRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryAuctionPriceRequest)(nil)
}
func (x fastReflection_QueryAuctionPriceRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryAuctionPriceRequest)
}
func (x fastReflection_QueryAuctionPriceRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryAuctionPriceRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryAuctionPriceRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryAuctionPriceRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryAuctionPriceRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryAuctionPriceRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryAuctionPriceRequest) New() protoreflect.Message {
	return new(fastReflection_QueryAuctionPriceRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryAuctionPriceRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryAuctionPriceRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryAuctionPriceRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.AuctionId != uint64(0) {
		value := protoreflect.ValueOfUint64(x.AuctionId)
		if !f(fd_QueryAuctionPriceRequest_auction_id, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryAuctionPriceRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "side.auction.QueryAuctionPriceRequest.auction_id":
		return x.AuctionId != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.auction.QueryAuctionPriceRequest"))
		}
		panic(fmt.Errorf("message side.auction.QueryAuctionPriceRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryAuctionPriceRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "side.auction.QueryAuctionPriceRequest.auction_id":
		x.AuctionId = uint64(0)
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryAuctionPriceRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "side.auction.QueryAuctionPriceRequest.auction_id":
		value := x.AuctionId
		return protoreflect.ValueOfUint64(value)
	default:
		...
		panic(fmt.Errorf("message side.auction.QueryAuctionPriceRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryAuctionPriceRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "side.auction.QueryAuctionPriceRequest.auction_id":
		x.AuctionId = value.Uint()
	default:
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryAuctionPriceRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "side.auction.QueryAuctionPriceRequest.auction_id":
		panic(fmt.Errorf("field auction_id of message side.auction.QueryAuctionPriceRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.auction.QueryAuctionPriceRequest"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryAuctionPriceRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "side.auction.QueryAuctionPriceRequest.auction_id":
		return protoreflect.ValueOfUint64(uint64(0))
	default:
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryAuctionPriceRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in side.auction.QueryAuctionPriceRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryAuctionPriceRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryAuctionPriceRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryAuctionPriceRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryAuctionPriceRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryAuctionPriceRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryAuctionPriceRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryAuctionPriceRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
var (
	md_QueryAuctionPriceResponse          protoreflect.MessageDescriptor
	fd_QueryAuctionPriceResponse_price    protoreflect.FieldDescriptor
	fd_QueryAuctionPriceResponse_discount protoreflect.FieldDescriptor
)

func init() {
	file_side_auction_query_proto_init()
	md_QueryAuctionPriceResponse = File_side_auction_query_proto.Messages().ByName("QueryAuctionPriceResponse")
	fd_QueryAuctionPriceResponse_price = md_QueryAuctionPriceResponse.Fields().ByName("price")
	fd_QueryAuctionPriceResponse_discount = md_QueryAuctionPriceResponse.Fields().ByName("discount")
}

var _ protoreflect.Message = (*fastReflection_QueryAuctionPriceResponse)(nil)

type fastReflection_QueryAuctionPriceResponse QueryAuctionPriceResponse

func (x *QueryAuctionPriceResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryAuctionPriceResponse)(x)
}

func (x *QueryAuctionPriceResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_side_auction_query_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_QueryAuctionPriceResponse_messageType fastReflection_QueryAuctionPriceResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryAuctionPriceResponse_messageType{}

type fastReflection_QueryAuctionPriceResponse_messageType struct{}

func (x fastReflection_QueryAuctionPriceResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryAuctionPriceResponse)(nil)
}
func (x fastReflection_QueryAuctionPriceResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryAuctionPriceResponse)
}
func (x fastReflection_QueryAuctionPriceResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryAuctionPriceResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryAuctionPriceResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryAuctionPriceResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryAuctionPriceResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryAuctionPriceResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryAuctionPriceResponse) New() protoreflect.Message {
	return new(fastReflection_QueryAuctionPriceResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryAuctionPriceResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryAuctionPriceResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryAuctionPriceResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Price != "" {
		value := protoreflect.ValueOfString(x.Price)
		if !f(fd_QueryAuctionPriceResponse_price, value) {
			return
		}
	}
	if x.Discount != uint32(0) {
		value := protoreflect.ValueOfUint32(x.Discount)
		if !f(fd_QueryAuctionPriceResponse_discount, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryAuctionPriceResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "side.auction.QueryAuctionPriceResponse.price":
		return x.Price != ""
	case "side.auction.QueryAuctionPriceResponse.discount":
		return x.Discount != uint32(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.auction.QueryAuctionPriceResponse"))
		}
		panic(fmt.Errorf("message side.auction.QueryAuctionPriceResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryAuctionPriceResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "side.auction.QueryAuctionPriceResponse.price":
		x.Price = ""
	case "side.auction.QueryAuctionPriceResponse.discount":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryAuctionPriceResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "side.auction.QueryAuctionPriceResponse.price":
		value := x.Price
	...
	default:
		...
		panic(fmt.Errorf("message side.auction.QueryAuctionPriceResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryAuctionPriceResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "side.auction.QueryAuctionPriceResponse.price":
		x.Price = value.Interface().(string)
	case "side.auction.QueryAuctionPriceResponse.discount":
		x.Discount = uint32(value.Uint())
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.auction.QueryAuctionPriceResponse"))
		}
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryAuctionPriceResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "side.auction.QueryAuctionPriceResponse.price":
		panic(fmt.Errorf("field price of message side.auction.QueryAuctionPriceResponse is not mutable"))
	case "side.auction.QueryAuctionPriceResponse.discount":
		panic(fmt.Errorf("field discount of message side.auction.QueryAuctionPriceResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: side.auction.QueryAuctionPriceResponse"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryAuctionPriceResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "side.auction.QueryAuctionPriceResponse.price":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryAuctionPriceResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in side.auction.QueryAuctionPriceResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryAuctionPriceResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryAuctionPriceResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryAuctionPriceResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryAuctionPriceResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryAuctionPriceResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
		...
		if x.Discount != 0 {
			n += 1 + runtime.Sov(uint64(x.Discount))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.Discount != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.Discount))
			i--
			dAtA[i] = 0x10
		}
		if len(x.Price) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryAuctionPriceResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryAuctionPriceResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
			...
			case 2:
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.Discount |= uint32(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (x *QueryAuctionPriceRequest) Reset() {
	*x = QueryAuctionPriceRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_side_auction_query_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryAuctionPriceRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryAuctionPriceRequest) ProtoMessage() {}

// Deprecated: Use QueryAuctionPriceRequest.ProtoReflect.Descriptor instead.
func (*QueryAuctionPriceRequest) Descriptor() ([]byte, []int) {
	return file_side_auction_query_proto_rawDescGZIP(), []int{10}
}

func (x *QueryAuctionPriceRequest) GetAuctionId() uint64 {
	if x != nil {
		return x.AuctionId
	}
	return 0
...
func (x *QueryAuctionPriceResponse) Reset() {
	*x = QueryAuctionPriceResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_side_auction_query_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryAuctionPriceResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryAuctionPriceResponse) ProtoMessage() {}

// Deprecated: Use QueryAuctionPriceResponse.ProtoReflect.Descriptor instead.
func (*QueryAuctionPriceResponse) Descriptor() ([]byte, []int) {
	return file_side_auction_query_proto_rawDescGZIP(), []int{11}
}

func (x *QueryAuctionPriceResponse) GetPrice() string {
	if x != nil {
		return x.Price
	}
	return ""
...
func (x *QueryAuctionPriceResponse) GetDiscount() uint32 {
	if x != nil {
		return x.Discount
	}
	return 0
...
var file_side_auction_query_proto_rawDesc = []byte{
	...
	0x0a, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x39, 0x0a, 0x18, 0x51,
	0x75, 0x65, 0x72, 0x79, 0x41, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x69, 0x63, 0x65,
	...
	,
	...
	,
	...
	0x69, 0x6f, 0x6e, 0x2f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x42, 0x9e, 0x01, 0x0a, 0x10, 0x63, 0x6f,
	0x6d, 0x2e, 0x73, 0x69, 0x64, 0x65, 0x2e, 0x61, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x0a,
	...
	0x69, 0x64, 0x65, 0x2f, 0x61, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0xa2, 0x02, 0x03, 0x53, 0x41,
	0x58, 0xaa, 0x02, 0x0c, 0x53, 0x69, 0x64, 0x65, 0x2e, 0x41, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0xca, 0x02, 0x0c, 0x53, 0x69, 0x64, 0x65, 0x5c, 0x41, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0xe2,
	0x02, 0x18, 0x53, 0x69, 0x64, 0x65, 0x5c, 0x41, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5c, 0x47,
	0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x0d, 0x53, 0x69, 0x64,
	0x65, 0x3a, 0x3a, 0x41, 0x75, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_side_auction_query_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_side_auction_query_proto_goTypes = []interface{}{
	...
	(*QueryAuctionPriceRequest)(nil),  // 10: side.auction.QueryAuctionPriceRequest
	(*QueryAuctionPriceResponse)(nil), // 11: side.auction.QueryAuctionPriceResponse
	(*Params)(nil),                    // 12: side.auction.Params
	(*Auction)(nil),                   // 13: side.auction.Auction
	(AuctionStatus)(0),                // 14: side.auction.AuctionStatus
	...
	(*Bid)(nil),                       // 17: side.auction.Bid
	(BidStatus)(0),                    // 18: side.auction.BidStatus
}
var file_side_auction_query_proto_depIdxs = []int32{
	12, // 0: side.auction.QueryParamsResponse.params:type_name -> side.auction.Params
	13, // 1: side.auction.QueryAuctionResponse.auction:type_name -> side.auction.Auction
	14, // 2: side.auction.QueryAuctionsRequest.status:type_name -> side.auction.AuctionStatus
	15, // 3: side.auction.QueryAuctionsRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	13, // 4: side.auction.QueryAuctionsResponse.auctions:type_name -> side.auction.Auction
	16, // 5: side.auction.QueryAuctionsResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	17, // 6: side.auction.QueryBidResponse.bid:type_name -> side.auction.Bid
	18, // 7: side.auction.QueryBidsRequest.status:type_name -> side.auction.BidStatus
	15, // 8: side.auction.QueryBidsRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	17, // 9: side.auction.QueryBidsResponse.bids:type_name -> side.auction.Bid
	16, // 10: side.auction.QueryBidsResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	...
	10, // 16: side.auction.Query.AuctionPrice:input_type -> side.auction.QueryAuctionPriceRequest
	1,  // 17: side.auction.Query.Params:output_type -> side.auction.QueryParamsResponse
	3,  // 18: side.auction.Query.Auction:output_type -> side.auction.QueryAuctionResponse
	5,  // 19: side.auction.Query.Auctions:output_type -> side.auction.QueryAuctionsResponse
	7,  // 20: side.auction.Query.Bid:output_type -> side.auction.QueryBidResponse
	9,  // 21: side.auction.Query.Bids:output_type -> side.auction.QueryBidsResponse
	11, // 22: side.auction.Query.AuctionPrice:output_type -> side.auction.QueryAuctionPriceResponse
...
func file_side_auction_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_side_auction_query_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryAuctionPriceRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_side_auction_query_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryAuctionPriceResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
