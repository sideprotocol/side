...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=sidechain \
          -X github.com/cosmos/cosmos-sdk/version.AppName=$(SIDECHAIN_BINARY) \
...
IBC_GO_URL          = https://raw.githubusercontent.com/cosmos/ibc-go/v6.1.0
