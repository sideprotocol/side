...
func (k Keeper) InitiateResharingRequest(ctx sdk.Context, dkgId uint64, removedParticipants []string, newParticipants []string, timeoutDuration time.Duration) *types.ResharingRequest {
