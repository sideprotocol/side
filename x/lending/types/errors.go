...
var (
	...
	ErrInvalidDepositTx        = errorsmod.Register(ModuleName, 3008, "invalid deposit tx")
	ErrInvalidCET              = errorsmod.Register(ModuleName, 3009, "invalid cet")
	ErrInvalidEvent            = errorsmod.Register(ModuleName, 3010, "invalid event")
	ErrInsufficientCollateral  = errorsmod.Register(ModuleName, 3011, "insufficient collateral")
	ErrLiquidationPriceReached = errorsmod.Register(ModuleName, 3012, "liquidation price reached")
	ErrMaturityTimeReached     = errorsmod.Register(ModuleName, 3013, "maturity time reached")
	ErrFailedToBuildTx         = errorsmod.Register(ModuleName, 3014, "failed to build tx")
