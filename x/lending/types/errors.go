...
var (
	...
	ErrDebtCeilingExceeded     = errorsmod.Register(ModuleName, 3006, "debt ceiling exceeded")
	ErrInvalidDCM              = errorsmod.Register(ModuleName, 3007, "invalid dcm")
	ErrEmptyLoanId             = errorsmod.Register(ModuleName, 3008, "empty loan id")
	ErrLoanDoesNotExist        = errorsmod.Register(ModuleName, 3009, "loan does not exist")
	ErrInvalidDepositTx        = errorsmod.Register(ModuleName, 3010, "invalid deposit tx")
	ErrInvalidCET              = errorsmod.Register(ModuleName, 3011, "invalid cet")
	ErrInvalidEvent            = errorsmod.Register(ModuleName, 3012, "invalid event")
	ErrInsufficientCollateral  = errorsmod.Register(ModuleName, 3013, "insufficient collateral")
	ErrLiquidationPriceReached = errorsmod.Register(ModuleName, 3014, "liquidation price reached")
	ErrMaturityTimeReached     = errorsmod.Register(ModuleName, 3015, "maturity time reached")
