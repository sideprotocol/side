...
var (
	...
	ErrPendingAgencyPubKeyExists = errorsmod.Register(ModuleName, 1115, "pending agency public key already exists")
	ErrInvalidAgencyStatus       = errorsmod.Register(ModuleName, 1116, "invalid agency status")
