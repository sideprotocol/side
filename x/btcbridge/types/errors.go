...
var (
	...
	ErrFailToSerializePsbt      = errorsmod.Register(ModuleName, 3106, "failed to serialize psbt")
	ErrInvalidSignatures        = errorsmod.Register(ModuleName, 3107, "invalid signatures")
	ErrWithdrawRequestNotExist  = errorsmod.Register(ModuleName, 3108, "withdrawal request does not exist")
	ErrWithdrawRequestConfirmed = errorsmod.Register(ModuleName, 3109, "withdrawal request has been confirmed")
