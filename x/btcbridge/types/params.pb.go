...
type Params struct {
	...
	// TSS params
	TssParams *TSSParams `protobuf:"bytes,9,opt,name=tss_params,json=tssParams,proto3" json:"tss_params,omitempty"`
}
...
type TSSParams struct {
	...
	DkgTimeoutPeriod *time.Duration `protobuf:"bytes,1,opt,name=dkg_timeout_period,json=dkgTimeoutPeriod,proto3,stdduration" json:"dkg_timeout_period,omitempty"`
	// Transition period after which TSS participants update process is completed
	ParticipantUpdateTransitionPeriod *time.Duration `protobuf:"bytes,2,opt,name=participant_update_transition_period,json=participantUpdateTransitionPeriod,proto3,stdduration" json:"participant_update_transition_period,omitempty"`
}
...
var fileDescriptor_f1d33573cda8a6d2 = []byte{
	...
	,
}
...
func (m *TSSParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.ParticipantUpdateTransitionPeriod != nil {
...
func (m *TSSParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.DkgTimeoutPeriod == nil {
				m.DkgTimeoutPeriod = new(time.Duration)
			}
		...
		case 2:
			...
			if m.ParticipantUpdateTransitionPeriod == nil {
				m.ParticipantUpdateTransitionPeriod = new(time.Duration)
			}
